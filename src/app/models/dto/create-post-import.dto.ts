...
import {
  ...
  GUEST_COUNT_MIN,
  PHOTOS_ARRAY_LENGTH, POST_RATING_MAX, POST_RATING_MIN,
...
export default class CreatePostImportDto {
  ...
  @IsBoolean({message: 'Field favorite must be a boolean'})
  public favorite!: boolean;

  @IsInt({message: 'rating must be an integer'})
  @Min(POST_RATING_MIN, {message: `Minimum count is ${POST_RATING_MIN}`})
  @Max(POST_RATING_MAX, {message: `Maximum count is ${POST_RATING_MAX}`})
